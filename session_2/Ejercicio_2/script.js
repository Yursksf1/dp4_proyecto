...
function run() {
    ...
    // resulatado = parseInt(number_1) - parseInt(number_2);
    // alert('la resta de ' + number_1 + ' - ' + number_2 + ' = ' + resulatado);

    // // aca esta la multiplicacion 
...
function run_2() { console.log('estoy corriendo la funcion run_2')}
function run_3() { console.log('estoy corriendo la funcion run_3')}
function run_4() { console.log('estoy corriendo la funcion run_4')}